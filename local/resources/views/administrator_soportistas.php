				 		...
				 		<div class="padding-left">
					 		<div class="manage-jobs-sec addscroll">
					 			...
					 			<div class="extra-job-info"> 
						 			<span><i class="la la-plus"></i><strong>&nbsp;</strong><a href="soportistas/nuevo" title="">Nuevo soportista</a></span>
						 		</div> 
						 		<table>
						 			<thead>
						 				<tr>
						 				...
						 				<tr>
						 					...
						 					<td>
						 						...
						 						<?php if ($key->estatus==1): ?>
						 								<li><span>Bloquear</span><a href="soportistas/bloquear/<?php echo $key->id;?>" title=""><i class="la la-unlock-alt"></i></a></li>	
						 							<?php endif ?>
						 							<?php if ($key->estatus==0): ?>
						 								<li><span>Desbloquear</span><a href="soportistas/desbloquear/<?php echo $key->id;?>" title=""><i class="la la-unlock"></i></a></li>	
						 							<?php endif ?>  
						 							<li><span>Editar</span><a href="soportistas/<?php echo $key->id;?>" title=""><i class="la la-pencil"></i></a></li> 
						 						</ul>
						 					</td>
						 				</tr> 
						 				<?php endforeach ?>
