							...
							<div class="col-lg-9 column">
								...
								<div class="bloglist-sec">
									<div class="blogpost style2">
										<div class="blog-posthumb"> <a href="#" title=""><img src="http://placehold.it/322x280" alt=""></a> </div>
										<div class="blog-postdetail">
											<ul class="post-metas"><li><a href="#" title=""><i class="la la-calendar-o"></i>Noviembre 23 de 2018 </a></li><li><a class="metascomment" href="#" title=""><i class="la la-comments"></i>4 comentarios</a></li></ul>
											<h3><a href="#" title="">Maduro se mando. esta loco la la verga.</a></h3>
											<p>Y mas loco lo que los apoyan.</p>
											<a class="bbutton" href="#" title="">Ver más <i class="la la-long-arrow-right"></i></a>
										</div>
										</div><!-- Blog Post -->
									</div>
