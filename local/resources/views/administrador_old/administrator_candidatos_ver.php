										...
										<div class="emply-resume-sec">
											<div class="emply-resume-list">
												...
												<div class="emply-resume-info">
													<h3><a href="#" title="">Victor Fernández</a></h3>
													<span><i>PHP / MySQL</i> Programador</span>
													<p><i class="la la-map-marker"></i>Zulia / Venezuela</p>
												</div>
												<div class="shortlists">
													<a href="#" title="">Ver <i class="la la-plus"></i></a>
												</div>
												</div><!-- Emply List -->
											</div>
