    ...
    return this.each(function() {
        ...
        function addLabel(str) {
            if (tagInput.children('span.tagLabel').length > 0) {
                ...
                label = $('<span class="' + settings.labelClass + ' tagLabel" data-badge="' + id + '">' + str + ' <span style="cursor:pointer;" href="" data-badge="' + id + '" aria-label="close" class="closelabel">&times;</span></span> ').insertAfter(badge);
            } else {
                label = $('<span class="' + settings.labelClass + ' tagLabel" data-badge="1">' + str + ' <span style="cursor:pointer;" href="" data-badge="1" aria-label="close" class="closelabel">&times;</span></span> ').insertBefore(textInput);
            }
