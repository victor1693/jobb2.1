				 	...
				 	<div class="col-lg-9 column"> 
					 	<div class="padding-left" style="margin-top: -70px;">
                                    ...
                                    <div class="manage-jobs-sec addscroll" style="margin-top: 50px;">
                                        <h3>Editar redactor</h3>
                                    </div>
                                </div>
                          <div class="profile-form-edit" style="margin: 0px;">
                                    <form id="formulario" action="../actualizarredactor" method="POST" style="margin: 0px;" id="form_candiactualizardatos">
                                        <input name="_token" type="hidden" value="<?php echo csrf_token();?>" id="my_token">
                                        <input name="id" type="hidden" value="<?php echo $datos[0]->id;?>" id="my_token">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <span class="pf-title">Nombre</span>
                                                <div class="pf-field">
                                                    <input value="<?php echo $datos[0]->nombre;?>" name="nombre" id="nombre" type="text" placeholder="Correo electrónico">
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <span class="pf-title">Función</span>
                                                <div class="pf-field">
                                                    <input value="<?php echo $datos[0]->funcion;?>" name="funcion" id="funcion" type="text" placeholder="Correo electrónico">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="pf-field">
                                                    <input value="<?php echo $datos[0]->clave;?>" placeholder="Clave" name="clave" id="clave" type="text">
                                                </div>
                                            </div>
