...
?>
   <link rel="stylesheet" href="<?php echo $retroceder;?>local/resources/views/errors/css/style.css"> 
</head>
...
<div class="text">
  <div class="text-inner">
    ...
    <h2>Disculpe, algo no ha salido bien. Vuelva al inicio. </h2>

    <div id="" class="button">
      
      <h3 style="cursor: pointer;" onClick="location.href='http://jobbersargentina.net'">Inicio</h3>
    </div>
	</div>
