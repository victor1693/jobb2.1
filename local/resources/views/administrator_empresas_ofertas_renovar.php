						 	 ...
						 	 <form action="ofertas-renovar" method="get" id="form_search">
						 		...
						 		<table>
						 			<thead>
						 				<tr>
						 					<td width="35">No.</td>   
						 					<td width="450">Titulo oferta</td>   
						 					<td>Fecha oferta</td>   
						 					<td>Días antigüedad</td>
						 					<td>Opciones</td>
						 				</tr>
						 			</thead>
						 			...
						 			<tbody>
						 				<?php foreach ($ofertas as $i => $oferta): ?>
						 					...
						 					<tr>
						 						...
						 						<td>
						 							<div class="table-list-title">
						 								<h3><a href="<?= url('detalleoferta') ?>/<?= $oferta->id_pub ?>" title="" target="_blank"><?= $oferta->titulo ?></a></h3>
						 								<span><i class="la la-industry"></i> <?= $oferta->nombre_empresa ?> - <?= $oferta->plan ?></span>
						 							</div>
						 						</td>
						 						<td><div class="table-list-title">
						 							<h3><?= $oferta->creacion_oferta ?></h3>
						 								
						 							</div>
						 						</td>
						 						<td align="center"><div class="table-list-title">
						 							<h3><?= $oferta->dias_antiguos ?></h3>
						 						...
						 						<td>
						 							<ul class="action_job">
						 							<li><span>Renovar</span><a href="<?= url('administracion/empresas/renewOferta') ?>/<?= $oferta->id_pub ?>/<?= $oferta->id_empresa ?>" title=""><i class="fa fa-refresh"></i></a></li>
						 						</ul>
						 						</td>
						 					</tr>
