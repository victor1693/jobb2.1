...
<div id="frame">
        ...
        <div id="contacts">
            <ul>
              <?php foreach ($datos as $key): ?>
                  <li class="contact">
                    <div class="wrap" onClick="location.href ='../candisoported/<?php echo $key->codigo;?>'"> 
                        <img src="../local/resources/views/images/soportes.png" alt="" />
                        <div class="meta">
                            <p class="name"><?php echo substr($key->titulo, 0,15)."...";?></p>
                            <p class="preview"><?php echo $key->tmp;?></p>
                        </div>
                    </div>
                </li> 
              <?php endforeach ?>
    ...
    <div class="content">
        <div class="contact-profile">
            <img src="../local/resources/views/images/soporte_jobbers.png" alt="" />
            <p>Soporte Jobbers</p>
             <a href="../inicio" style="float: right;padding-right:10px;text-decoration: none;color: #383838;">Inicio</a> 
            <a href="../candidashboard" style="float: right;padding-right:10px;text-decoration: none;color: #383838;">Mi panel</a> 
...
{ 
  ...
  if(incrementar>0 && tipo_de_mensaje==2)
  {  
   $("#audio")[0].play(); 
  }
  desplazar();
