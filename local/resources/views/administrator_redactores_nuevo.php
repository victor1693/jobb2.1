				 	...
				 	<div class="col-lg-9 column"> 
					 	<div class="padding-left" style="margin-top: -70px;">
                                    ...
                                    <div class="manage-jobs-sec addscroll" style="margin-top: 50px;">
                                        <h3>Nuevo redactor</h3>
                                    </div>
                                </div>
                          <div class="profile-form-edit" style="margin: 0px;">
                                     <form id="formulario" action="../nuevoredactor" method="POST" style="margin: 0px;" id="form_candiactualizardatos">
                                       ...
                                       <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="pf-field">
                                                    <input value="" placeholder="Clave" name="clave" id="clave" type="text">
                                                </div>
                                            </div>
